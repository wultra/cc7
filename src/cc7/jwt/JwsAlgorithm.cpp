...
JwsAlgorithm::JwsAlgorithm(const JwsSpec* spec) :
    _spec(spec)
{
}

const JwsSpec* JwsAlgorithm::getSpec() const
{
    return _spec;
}

ByteArray JwsAlgorithm::sign(const JwtKey& key, const ByteRange& data) const
{
    throw std::logic_error("not implemented");
}

bool JwsAlgorithm::verify(const JwtKey& key, const ByteRange& data, const ByteRange& signature) const
{
    throw std::logic_error("not implemented");
}

JwsAlgorithmPtr JwsAlgorithm::getInstance(const std::string& algorithm)
{
