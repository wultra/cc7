        ...
        void testCompactTokens()
        {
            std::vector<CompactData> test_data {
                // powerauth-crypto test vectors
                {
                    ...
                    JwtKey::symmetricKey("HS256", Base64::decode("USlRczeq9SsWGnU+NUmmFMlFwJzsC43CFQvYZeBqnEg=")),
                    TEST_OK
                },
                {
            ...
            const std::vector<CompositeData> composite_vectors {
                {
                    ...
                    {
                        JwtKey::publicKey(publicKey("P-384", "BG/pz6Gomet1gaEhki+xcaWM4gPs119wG7MpjsmlryuuUqQ5l/qia6vrjpDUDGCpp1VmiGambEl42k1bDeNBPhUQW/lZxoVZQeQrBwJjF++AyP4P5vXxQ3hOUYRrpKCjmg==", crypto::KEY_FORMAT_RAW))
                    },
                    TEST_OK
                },
                {
