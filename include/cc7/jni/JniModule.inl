...
/**
 ...
 #define CC7_JNI_CPP_CLASS      YourNativeClass             // Name of CPP class (informative only, not used)
...
#if !defined(CC7_JNI_CLASS_PATH) || !defined(CC7_JNI_CLASS_PACKAGE) || !defined(CC7_JNI_JAVA_CLASS)
#error "This is an inline header. You have to define CC7_JNI_CLASS_PATH & CC7_JNI_CLASS_PACKAGE & CC7_JNI_JAVA_CLASS macros before include."
#endif
...
/**
 CC7_JNI_CLASS_BEGIN wraps subsequent code into the extern "C" block.
 */
...
/**
 ...
 CC7_JNI_STATIC_METHOD(jboolean, hasThisMightyFeature)
 {
 }

 CC7_JNI_STATIC_METHOD(void, doVeryImportantStuff)
 {
 }
 */
#define CC7_JNI_STATIC_METHOD(return_type, name)                                                           \
    JNIEXPORT return_type JNICALL __CC7_JNI_CONCAT_PATH(CC7_JNI_CLASS_PACKAGE,CC7_JNI_JAVA_CLASS,name) (JNIEnv* env, jclass clazz)

/**
 Declares a prototype for method with parameters. You can also use this macro in the actual method
 implementation. For example:

 CC7_JNI_STATIC_METHOD_PARAMS(jint, calculateVeryImportantValue, jint input)
 {
 }

 CC7_JNI_STATIC_METHOD_PARAMS(void, setThatMagnificentFlag, jboolean value)
 {
 }
 */
#define CC7_JNI_STATIC_METHOD_PARAMS(return_type, name, paramz...)                                         \
    JNIEXPORT return_type JNICALL __CC7_JNI_CONCAT_PATH(CC7_JNI_CLASS_PACKAGE,CC7_JNI_JAVA_CLASS,name)(JNIEnv* env, jclass clazz, paramz)
