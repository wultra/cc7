...
public:
     ...
     */
    DataWriter(ByteArray * out_buffer = nullptr);
     ...
     */
    void writeData(const ByteRange & data);
    /**
     ...
     */
    void writeMemory(const ByteRange & range);
    
    /**
     Returns serialized data.
     */
    const ByteArray & serializedData() const;
    ...
    /**
     Just pops version from the stack.
     */
    void closeVersion();
    /**
...
private:
    ...
    ByteArray *     _data;      // TODO: use shared_ptr<> here
