...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "openssl",
            url: "https://github.com/wultra/cc7/releases/download/0.7.2/openssl-3.5.6.xcframework.zip",
            checksum: "7816096d4db2a6e13fcc65c1e266efc091ac6c6efa0c1d355058a2df1049bdf2"
        ),
        .target(
            name: "cc7",
            dependencies: [
